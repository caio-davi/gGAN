...
def define_discriminator(in_shape=(3,4,1), n_classes=2):
    # image input
...
# plot_model(c_model, to_file='./images/discriminator1_3x4_plot.png', show_shapes=True, show_layer_names=True)
# plot_model(d_model, to_file='./images/discriminator2_3x4_plot.png', show_shapes=True, show_layer_names=True)
...
def define_generator(latent_dim):
    ...
    # upsample to 3x4
    gen = Conv2DTranspose(128, (2,2), strides=(3,4), padding='same')(gen)
    gen = LeakyReLU(alpha=0.2)(gen)
    # upsample to 6x8
