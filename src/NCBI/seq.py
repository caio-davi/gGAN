...
Entrez.email = "caio.davi@tamu.edu"
...
def get_snp(q, quiet = False):
    ...
    for snp_info in filter(None,response.split('\n\n')):
        print (snp_info) if not quiet else 0
...
snp = get_snp(["rs2069718"], quiet = True)
pp = pprint.PrettyPrinter(indent=4)
pp.pprint(snp['rs2069718']['LOC'][0]['symbol'])